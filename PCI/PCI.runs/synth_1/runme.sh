...
HD_PWD='F:/pci dream/PCI/PCI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log REQ_THREADER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source REQ_THREADER.tcl
